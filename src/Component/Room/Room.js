        ...
        <div className="rooms_container">
          <div data-aos="fade-down" className="card_room">
            ...
            <div>
              ...
              <p>
            Blending natural colors and wooden furnishings, our rooms are designed to indulge you. Spacious and well- ventilated, they are equipped with all modern amenities to make your stay comfortable.
              </p> 
              <Link
                to="/Executive"
                class="link link--thebe anime_link room_btn"
              >
                See More Details <i class="fas fa-arrow-right"></i>
              </Link>
            </div>
          </div>
          <div data-aos="fade-down" className="card_room">
