    ...
    <div>
      <div class="offer_new">
        <div class="offer__content">
          <h1 className="animate-hero">Our Offerings</h1>
        </div>
      </div>
      <div className="offer">
          ...
          <div data-aos="flip-up" className="offer_card">
            ...
            <div className="offer_content">
              ...
              <button class="button button--mimas button_anime btn_offer">
                <Link to='/Dining'><span>Book Now</span></Link>
              </button>
            </div>
          </div>
          <div data-aos="flip-up" className="offer_card">
            ...
            <div className="offer_content">
              ...
              <Link to='/Executive'><span>Book Now</span></Link>
              </button>
            </div>
          </div>
          <div data-aos="flip-up" className="offer_card">
            ...
            <div className="offer_content">
              ...
              <Link to='/Spa'><span>Book Now</span></Link>
              </button>
            </div>
          </div>
        </div>
