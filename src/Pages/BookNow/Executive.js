    ...
    <div>
      <div class="executive_new">
        <div class="executive__content">
          <h1 className="animate-hero">Executive Suite</h1>
        </div>
      </div>
        ...
        <div className="detail_card">
          ...
          <div className="detail_features">
            ...
            <li>
                ...
                <i class="fas fa-utensils"></i>Dinning area
                </Link>
              </li>
              <li>
                <Link to="/" className="speacial">
                <i class="fa-solid fa-blender"></i>Kitchen
                </Link>
              </li>
              <li>
                <Link to="/" className="speacial">
                <i class="fa-solid fa-bath"></i>Bath dub
                </Link>
              </li>
              <br/>
              <li>
